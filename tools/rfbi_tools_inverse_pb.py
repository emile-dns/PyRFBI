...
class Mposterior:
    ...
    def __init__(self,
        ...
        self.Mprior = Mprior(self.n_layers,
                         self.param_set_list, self.param_set_values, self.param_inv_list, self.param_inv_prior, self.param_same_list, self.param_same_link)
    ...
    def pdf(self, m):
        ...
        a = self.Mprior.pdf(m)
        b = self.Lpolarity.pdf(amp_model, sig_amp_model) ** self.invert_polarity
